...
import com.changhong.foundation.logic.MsgAnfangLogic;
import com.changhong.foundation.logic.MsgHuiminLogic;
import com.changhong.foundation.logic.MsgSystemLogic;
...
public class MsgCenterActivity extends BaseActivity
{
    ...
    public List<SuperFragment> list = new ArrayList<SuperFragment>();
    ...
    {
        SuperFragment frg1 = new MsgAllFragment();
        SuperFragment frg2 = new MsgHuiminFragment();
        SuperFragment frg3 = new MsgTenementFragment();
        SuperFragment frg4 = new MsgSecurityFragment();
        SuperFragment frg5 = new MsgSystemFragment();
        list.add(frg1);
        list.add(frg2);
        list.add(frg3);
        list.add(frg4);
    ...
    public void clearData()
    {
        ...
        MsgHuiminLogic.getInstance().clear();
        MsgWuyeLogic.getInstance().clear();
        MsgAnfangLogic.getInstance().clear();
        MsgSystemLogic.getInstance().clear();
    }
    ...
    public class MyOnPageChangeListener implements OnPageChangeListener
    {
        ...
        public void onPageSelected(int arg0)
        {
            ...
            if (currIndex != 0)
            {
                adapter.getItem(currIndex).updateView(new Message());
            }
        }
    }
