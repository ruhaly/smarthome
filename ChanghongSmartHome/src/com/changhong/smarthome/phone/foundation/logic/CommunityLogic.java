...
public class CommunityLogic extends SuperLogic
{
    public List<Community> list = new ArrayList<Community>();
    
    public HttpHandler<String> httpHanlder;
    
    public static CommunityLogic ins;
    
    public static synchronized CommunityLogic getInstance()
    {
        if (null == ins)
        {
            ins = new CommunityLogic();
        }
        return ins;
    }
