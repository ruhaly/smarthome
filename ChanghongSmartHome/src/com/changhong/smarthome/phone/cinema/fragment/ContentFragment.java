...
public class ContentFragment extends SuperFragment implements OnClickListener
{
    ...
    public void onClick(View v)
    {
        ...
        {
            //
            showSearchPop(0, getActivity().getBaseContext(), exitLayout);
     ...
     * @param exitLayout2
     */
    private void showSearchPop(int yoffset, Context baseContext,
            RelativeLayout exitLayout2)
    {
        if (null != searchPopupWindow)
        {
            searchPopupWindow.dismiss();
        }
        searchPopupWindowView = getActivity().getLayoutInflater()
                .inflate(R.layout.cinema_search_pop, null);
        ...
        //)
        searchPopupWindow = new PopupWindow(searchPopupWindowView,
    ...
    
    {
        ...
        exitLayout = (RelativeLayout) v.findViewById(R.id.exitLayout);
