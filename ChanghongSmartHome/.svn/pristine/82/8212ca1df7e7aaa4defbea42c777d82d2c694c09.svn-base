...
public class RepairsFragment extends SuperFragment
{
     ...
     * 有报修记录的界面
     */
    private RelativeLayout bx_all_Layout;
    ...
    public void handleMsg(Message msg)
    {
        switch (msg.what)
        {
            ...
            case HttpAction.BXLIST_SUCCESS_MSGWHAT_ALL:
                if(GetBxItemListLogic.services_bxList.size() > 0)
                {
                    bx_half.setVisibility(View.GONE);
                    bx_all_Layout.setVisibility(View.VISIBLE);
                    bxlistadapter.updateData(GetBxItemListLogic.services_bxList);
                }
                else
                {
                    bx_half.setVisibility(View.VISIBLE);
                    bx_all_Layout.setVisibility(View.GONE);
                }
            ...
            case HttpAction.BXLIST_SUCCESS_MSGWHAT:
                ...
                if (curPage == 1)
                {
                    GetBxItemListLogic.services_bxList = (ArrayList<ServicesItem>) msg.obj;
                }
                else
                {
                    GetBxItemListLogic.services_bxList.addAll((ArrayList<ServicesItem>) msg.obj);
                }
            ...
            case HttpAction.BXDELETE_SUCCESS_MSGWHAT:
                GetBxItemListLogic.services_bxList.remove(bx);
    ...
    private void initHalf()
    {
        ...
        bx_half_2 = (TextView)view.findViewById(R.id.bx_half_2);
        
        bx_half_2.setOnClickListener(new OnClickListener()
        {
            ...
            Bundle savedInstanceState)
    {
        ...
        bx_all_Layout = (RelativeLayout) view.findViewById(R.id.bx_all_Layout);
...
//                bx_half.setVisibility(View.VISIBLE);
    ...
    public void initBxAdapter()
    {
        ...
        if (GetBxItemListLogic.services_bxList != null)
        {
            
            bxlistadapter = new BxlistAdapter(getActivity(),
                    GetBxItemListLogic.services_bxList);
            bxfwlistview.setAdapter(bxlistadapter);
