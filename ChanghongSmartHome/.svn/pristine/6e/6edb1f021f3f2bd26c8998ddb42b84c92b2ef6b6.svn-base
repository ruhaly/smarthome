...
public class LoginLogic extends SuperLogic
{
    ...
    {
        baseAccountInfo.setAccountId(ins.user.getAccount());
        baseAccountInfo.setUserId(ins.user.getUid());
        baseAccountInfo.setCommunityCode(ins.curCommunity.getCommunityId());
        baseAccountInfo.setFlag(Constant.TERMINAL_TYPE);
        baseAccountInfo.setResolution("QHD");
        baseAccountInfo.setType("1");
    ...
    public void requestLogin(String account, String pwd, HttpUtils httpUtils)
    {
        ...
        serviceInfo.put("organId", curCommunity.getCommunityId());
    ...
    public void requestModifyPersonInfo(String headPic, String nickName,
            String sex, HttpUtils httpUtils)
    {
        RequestParams params = new RequestParams();
        Map<String, Object> serviceInfo = new HashMap<String, Object>();
        serviceInfo.put("headPic", headPic);
