...
public class ResultCode
{
     ...
     * 关系圈被授权用户不存在
     */
    public static final String APPROVETO_USER_NOT_EXIST = "530";
    
    /**
     * 关系圈授权用户不存在
     */
    public static final String APPROVEBY_USER_NOT_EXIST = "531";
    
    /**
     * 被授权用户权限不正确
     */
    public static final String APPROVETO_PERMIT_NOT_CORRECT = "532";
    
    /**
     * 授权用户权限不正确
     */
    public static final String APPROVEBY_PERMIT_NOT_CORRECT = "533";
