...
public class OrderManagerFragment1 extends SuperFragment
{
    
    private static final String TAG = "OrderManagerFragment1";
    ...
    public void findOrders()
    {
        ...
        orderOldestLogic.sendFindOrdersReq("1", pagerBean, mode,1,httpUtils);
    }
...
//            case DATA_FORMAT_ERROR_MSGWHAT:
    ...
    private void initLogic()
    {
        ...
        orderOldestLogic.setData(fHandler);
