...
public class HttpUtils
{
    ...
    public HttpUtils(int connTimeout)
    {
        ...
        schemeRegistry.register(new Scheme("https",
                SimpleSSLSocketFactory.getSocketFactory(), 443));
    ...
    private static final ThreadFactory sThreadFactory = new ThreadFactory()
    {
        ...
        {
            Thread thread = new Thread(r, "HttpUtils #"
    ...
    private static Executor executor = Executors.newFixedThreadPool(threadPoolSize,
            sThreadFactory);
    ...
    public HttpUtils configRequestThreadPoolSize(int threadPoolSize)
    {
        if (threadPoolSize > 0 && threadPoolSize != HttpUtils.threadPoolSize)
        {
            ...
            HttpUtils.executor = Executors.newFixedThreadPool(threadPoolSize,
                    sThreadFactory);
        }
        return this;
    }
    ...
    {
        return download(HttpRequest.HttpMethod.GET,
                url,
                target,
                null,
                false,
            ...
            RequestParams params, RequestCallBack<T> callBack)
    {
        if (null != params)
        {
            AppLog.out("HttpUtils", "请求参数:"
                    + (null != params.getBodyParams() ? params.getBodyParams()
                            : ""), AppLog.LEVEL_INFO);
        }
