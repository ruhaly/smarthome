...
public class NotificationActivity extends FragmentActivity
{
     ...
     * 默认通知图标
     */
    public static int icon = R.drawable.ch_logo;
    
    /**
     * 默认通知图标
     */
    public static int titleId = R.string.appName;
    ...
    /**
     * 方法名称： showNotification 作者： hanliangru 方法描述： 显示通知 输入参数： @param view 通知界面 输入参数： @param
    ...
    public void showNotification(RemoteViews view, String soundUri,
            Intent intent, String tickerText, int id, String msg)
    {
        ...
        boolean playSound = getSharedPreferences(Constant.CONFIG_NAME,
                Context.MODE_PRIVATE).getBoolean(Constant.NOTIFYCATION_CHECK,
                true);
        ...
        else
        {
            pendingIntent = PendingIntent.getActivity(getBaseContext(),
                    0,
                    new Intent(getBaseContext(), this.getClass()),
                    0);
        }
        if (null != view)
        {
