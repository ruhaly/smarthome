...
public class RequestParams
{
            ...
            String mimeType, String fileName)
    {
        ...
        fileParams.put(key, new InputStreamBody(stream, length, mimeType,
                fileName));
    }
    ...
    public HttpEntity getEntity()
    {
        ...
        {
            result = new BodyParamsEntity(new ArrayList<NameValuePair>(
                    bodyParams.values()), charset);
        }
        
        return result;
    }
    
    public LinkedHashMap<String, NameValuePair> getBodyParams()
    {
        return bodyParams;
    }
